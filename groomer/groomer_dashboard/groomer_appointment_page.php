...
$select_appointments = "SELECT * FROM appointments WHERE groomer_id=$groomer_id AND is_expired=0 
                        ORDER BY appointment_date DESC, appointment_time,appointment_date,appointment_date";
...
<head>
    ...
    <!--######################### Load Groomer Appointment Page Custom Styling ############################-->
    <link rel="stylesheet" href="assets/css/groomer_appointment_page.css?<?php echo time(); ?>">
    <!--######################### Load Groomer Appointment Page Custom JS ############################-->
    <script src=assets/js/groomer_appointment_page.js?<?php echo time(); ?>"></script>
...
<div class="main">
    ...
    <div class="main-content">
        <div class="container">
            ...
            <?php }else{ ?>
                <h3 class="groomer_appoint_table_empty">Μέχρι στιγμής δεν υπάρχει κάποιο ραντεβού σε εξέλιξη.</h3>
            <?php } ?>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="form-group col-md-12" id="div_btn">
                    <button type="button" id="btn_accept" class="btn btn-primary btn-block accept">ΑΠΟΔΟΧΗ</button>
                </div>
                <div class="form-group col-md-12" id="div_btn">
                    <button type="button" id="btn_decline" class="btn btn-primary btn-block decline">ΑΠΟΡΡΙΨΗ</button>
                </div>
            </div>
        </div>
    </div>
