                ...
                success: function(response){
                    ...
                    $( ".accept" ).each(function() {
                        $(this).on("click", function () {
                            ...
                            var appointment_date = $('#appointment_table_date').text();
                            var appointment_time = $('#appointment_table_time').text();
                            var email = $('#appointment_table_email').text();
                            var surname = $('#appointment_table_name').text();
                            var phone = $('#appointment_table_phone').text();
                            Swal.fire({
                                icon: 'success',
                    ...
                    $( ".decline" ).each(function() {
                        $(this).on("click", function () {
                            ...
                            Swal.fire({
                                ...
                                confirmButtonText: 'Απόρριψη Ραντεβού',
