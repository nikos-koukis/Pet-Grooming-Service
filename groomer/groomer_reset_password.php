...
<head>
    ...
    <!--################# Load Groomer Change Password Custom Styling ##############################################-->
    <link rel="stylesheet" href="assets/css/groomer_reset_password.css">
    <!--################# Load Groomer Change Password Custom Custom JS ############################################-->
    <script src="assets/js/groomer_reset_password.js"></script>
        ...
        <form>
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <input type="email" class="form-control " id="groomer_email" name="groomer_email" readonly autocomplete="off" value="<?php echo $row['email'] ?>">
                </div>
            </div>
            ...
            <div class="form-group col-md-12">
                <button type="button" id="btn_groomer_reset_pass" name='btn_groomer_reset_pass' class="btn btn-primary btn-lg btn-block">Αλλαγή Κωδικού</button>
            </div>
        </form>
    </div>
</div>
