...
<head>
    ...
    <link rel="stylesheet" href="assets/css/forget_verified_code.css">
    <!--############################ Load Forget Verified Code Custom JS ###############################-->
    <script src="assets/js/forget_verified_code.js"></script>
...
<div class="col-md-12">
    <div class="d-flex justify-content-center ">
        <form name="admin_login_form" id="admin_login_form" method="post">
            ...
            <div class="form-group col-md-12">
                <button type="button" id="btn_resend_verified_email" name='btn_resend_verified_email' class="btn btn-warning btn-lg btn-block">Επαναποστολή Κωδικού</button>
            </div>
        </form>
    </div>
</div>
