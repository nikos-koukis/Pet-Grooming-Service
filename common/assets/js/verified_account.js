                ...
                success:function(response){
                    ...
                    if(response.indexOf('success') >= 0){
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: "Συγχαρητήρια!",
                            text: "Ο λογοριασμός σας επαληθεύτηκε με επιτυχία. Μπορείτε να συνδεθείτε στο παρακάτω σύνδεσμο",
                            footer: '<a href="../groomer/index.php">Συνδέσου</a>'

                        }).then(function() {
                            window.location = "../groomer/index.php";
                        });
