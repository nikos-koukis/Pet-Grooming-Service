...
<head>
    ...
    <link rel="stylesheet" href="assets/css/user_forget_password.css?<?php echo time(); ?>">
    <!--############################ Load Forget Verified Code Custom JS ###############################-->
    <script src="assets/js/user_forget_password.js?<?php echo time(); ?>"></script>
...
<div class="col-md-12">
    <div class="d-flex justify-content-center ">
        <form>
            ...
            <div class="form-group col-md-12">
                <button type="button" id="btn_forget_user_password" class="btn btn-warning btn-lg btn-block">Επαναφορά</button>
            </div>
        </form>
    </div>
</div>
